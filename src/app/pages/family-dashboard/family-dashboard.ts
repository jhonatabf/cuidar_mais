...
const FAMILY_COPY = {
  'pt-PT': {
    ...
    saved: 'Cadastro de família guardado e aprovado automaticamente.',
    ...
    statusApprovedMessage: 'O cadastro da família está ativo para encontrar cuidadores.',
    ...
    statusPendingMessage: 'O cadastro está registado e pode ser revisto pela equipa wecareparents.',
  },
  'en-GB': {
    ...
    saved: 'Family registration saved and automatically approved.',
    ...
    statusApprovedMessage: 'The family registration is active to find caregivers.',
    ...
    statusPendingMessage: 'The registration is recorded and may be reviewed by the wecareparents team.',
  },
} as const;
